...
# from infobs.stats import LinearInfoLog10 TODO
...
save_path = os.path.join(scriptpath, "results_main")
...
# handler.set_additional_stats(
#     {'linearinfolog10': LinearInfoLog10()}  TODO
# )
