...
env_name_list = ["av_3_24", "av_3_6", "av_6_12", "av_12_24"]
params_list = ["Avmax", "radm"] # "P"
if project == "kappa":
...
def procedure(
    dirname: str,
    orionb_compatible: bool
):
    
    if orionb_compatible:
        dirname = dirname + "_orionb"
    ...
    if not orionb_compatible:
        ...
        emir_lines = [
            ...
            "c_18o_j1__j0",
            "13c_o_j1__j0",
            "cn_n1_j1d5__n0_j0d5", # Line with the best SNR
            "co_v0_j1__v0_j0",
        ]
...
for orionb_compatible in [True, False]:
    procedure(dirname, orionb_compatible)
