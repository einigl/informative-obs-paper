...
with open(os.path.join(scriptpath, 'inputs_discrete_filaments.yaml'), 'r') as f:
...
lines, params = select_envs(lines, params, ["filaments"])


# Instantiate handler

save_path = os.path.join(scriptpath, "results_filaments")
