...
with open(os.path.join(scriptpath, 'inputs_discrete_pdr.yaml'), 'r') as f:
...
lines, params = select_envs(lines, params, ["horsehead", "pdr1"])


# Instantiate handler

save_path = os.path.join(scriptpath, "results_pdr")
